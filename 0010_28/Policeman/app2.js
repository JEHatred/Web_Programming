...
class Person{
    ...
    greet(){//Prororipo de la clase Person que agrega el metodo greet
...
class Policeman extends Person{
    ...
    nPoliceman(){//Se creo el prototipo de la clase Policeman heredada con la funcion nPoliceman
...
Person.prototype.greet = function(){//Prororipo de la clase Person que agrega el metodo greet
    console.log(`Hello ${this.firstName} ${this.lastName}`);//Desplique del contenido en la consola
}
